...
<div class="col-lg-10 col-lg-offset-1">
	<h3 class="text-center">Grafik <br>Jurusan <?=konvert('jurusan',$jurusan,'nama');?> (<?=konvert('tapel',$tapel,'tapel_awal');?>/<?=konvert('tapel',$tapel,'tapel_akhir');?>)</h3>
	<canvas id="myChart" heigth="400"></canvas>
</div>
<div class="col-lg-10 col-lg-offset-1">
	<h3 class="text-center">Tabel <br>Jurusan <?=konvert('jurusan',$jurusan,'nama');?> (<?=konvert('tapel',$tapel,'tapel_awal');?>/<?=konvert('tapel',$tapel,'tapel_akhir');?>)</h3>
